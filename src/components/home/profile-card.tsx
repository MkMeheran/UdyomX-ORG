...
export function ProfileCard() {
  return (
    <div className="bg-white border-4 border-black p-8 shadow-[8px_8px_0_0_rgba(0,0,0,1)] mb-8">
      <div className="flex flex-col md:flex-row items-start gap-6">
        ...
        <div className="flex-1 w-full">
          ...
          <p className="text-[#1A1A1A] mb-2 text-lg font-bold">
            A <span className="text-[#FF6B6B]">Digital Solutions</span> Organization
          </p>

          <p className="text-[#5A5A5A] mb-6 leading-relaxed max-w-3xl font-semibold">
          ...
          <div className="grid sm:grid-cols-2 gap-3 text-sm">
            <div className="flex items-center gap-2 border-3 border-black p-3 bg-[#F5F5F0] shadow-[3px_3px_0_0_rgba(0,0,0,1)]">
              ...
              <span className="font-bold text-[#1A1A1A]">contact@udyomx.com</span>
            </div>
            <div className="flex items-center gap-2 border-3 border-black p-3 bg-[#F5F5F0] shadow-[3px_3px_0_0_rgba(0,0,0,1)]">
              <div className="w-8 h-8 border-2 border-black bg-[#FF6B6B] flex items-center justify-center">
                <Sparkles className="w-4 h-4 text-white" />
              </div>
              <span className="font-bold text-[#1A1A1A]">Digital Innovation</span>
            </div>
            <div className="flex items-center gap-2 border-3 border-black p-3 bg-[#F5F5F0] shadow-[3px_3px_0_0_rgba(0,0,0,1)]">
            ...
            <div className="flex items-center gap-2 border-3 border-black p-3 bg-[#F5F5F0] shadow-[3px_3px_0_0_rgba(0,0,0,1)]">
              ...
              <span className="font-bold text-[#1A1A1A]">udyomx.com</span>
            </div>
          </div>

          {/* Founder & Social Links */}
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 mt-6 pt-6 border-t-4 border-black">
            ...
            <div className="flex items-center gap-3 sm:ml-auto">
              ...
              <button className="w-10 h-10 border-3 border-black bg-white hover:bg-[#1A1A1A] text-[#1A1A1A] hover:text-white flex items-center justify-center transition-all shadow-[3px_3px_0_0_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[1px_1px_0_0_rgba(0,0,0,1)]">
